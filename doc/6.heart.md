...
$$a \replace_{\plan}^{\outgo} a' = \left \langle \lBrace (a \asso a') \such \con_{\outgo}(a) \rBrace, A_{\plan} \setminus \{a\} \cup \{a'\} \right \rangle$$
...
::: example
The abstraction level of any atomic action is $0$ while it is $2$ for the composite action $make(drink)$.
:::
