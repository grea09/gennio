...
$$\lBrace \land \comp \models \circ \con \such A_{\plan} \rBrace \land (\threat(\plan) = \emptyset)$$
...
$$a \replace_{\plan}^{\outgo} a' = \left \langle \lBrace = \rtimes (a \asso a') \such \con_{\outgo}(a) \rBrace, A_{\plan} \setminus \{a\} \cup \{a'\} \right \rangle$$

It is the same with $\con_{\ingo}(a)$ for $a \replace^\ingo a'$. This supposes that the respective preconditions and effects of $a$ and $a'$ are equivalent. When not signed, the transposition is generalized: $a \replace a' = a \replace^\ingo a' \cup a \replace^\outgo a'$.
::::::::::::::::::::::::::::::::::::::::

::: example
$a\replace^\ingo a'$ gives all incoming links of $a$ with the $a$ replaced by $a'$.
:::
...
$a_n \oplus^{\plan_m}_{\plan} = \langle S_m \cup (S_{\plan} \setminus \lbrace a \rbrace) , a_n \rhd^- I_m \cup a_n \rhd^+ G_m \cup (L_{\plan} \setminus L_{\plan}(a_n))$.
