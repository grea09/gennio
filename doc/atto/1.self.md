...
This means that the world $W$ is a graph with the set of entities $E$ as vertices and the set of statements $S$ as edges. This model also suppose that every statement $s$ must be true if they belong to the domain $D$. This graph is a directed 3-uniform H-hypergraph.
