...
![Example of graph quotient.](graphics/todo.svg){#fig:quotient}
...
**TODO**: AND/OR trees in chapter 1 

![Example of and/or tree.](graphics/todo.svg){#fig:andor}
...
![Projection of a statement from the SELF to RDF space.](graphics/todo.svg){#fig:selfgraph}
...
![Venn diagram of subsets of $\bb{U}$ along with their relations. Dotted lines mean that the sets are defined a subset of the wider set.](graphics/todo.svg){#fig:typerel}
...
![Aristotle's square of opposition](graphics/todo.svg){#fig:aristotle}
