...
However, In the next section we aim to create such a general planning formalism.
...
* $\smwhtsquare_1 = \{held(no-block), on(blockA, blockB), down(blockC)\}$
...
![Example of a state encoded as an and/or tree.](graphics/todo.svg){#fig:state_tree}
