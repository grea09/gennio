...
A domain is a set of **operators** which are fully lifted *actions*, noted $\mathcal{D}$.
:::::::::::::::::::::::::::::::::::
...
**FIXME**: How to take into account in the general algorithm.

**TODO**: Chap 1 $\Interval$

#### General planner

A general planner $\mathbb{G}[\mathbb{S},\phi^+_{\mathbb{S}},h,\mathbb{e}](D,p)$ is an algorithm that can plan any formalism of automated planning.
...
A plan space refinement is a modification of a plan 
:::
