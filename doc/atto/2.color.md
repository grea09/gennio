...
The most classical representation of automated planning is using the state graph approach: actions are operators on the set of states and a plan is a state automata. 
