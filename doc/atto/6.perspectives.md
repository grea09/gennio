...
Conditional probabilities are probabilities of an event assuming that another related event is certain. This allows to evaluate the ways in which events are affecting one another. If the conditional probablity is equal to $0$, then the events are independant.
**TODO: Check + formula**
:::
...
This means that we can write : **FIXME**
