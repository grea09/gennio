...
This allows for existing intent recognition methods to be applied on the resulting plan without loosing on the advantages of partial order plans.
:::
