...
In order to quantify the expected diversity of a set of solution we introduce to $\gamma_{\searches}$ the plan distance metric $\Delta$ [@lee_generating_1999] that allows to compare how much two plans are different.
