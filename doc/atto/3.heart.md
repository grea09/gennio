...
*Example*: In the block world example we used previously, we can get the first flaws being the open conditions of the goal step. Once fixed, along with open, conditions of the added steps, we have a threat **TODO** as shown in @fig:flaws.
...
*Example*: From our previous example, **TODO** @fig:resolvers.
