...
The second phase is the initialisation. It starts pre-processing the planning domain and problem so that the planning phase gets significantly faster. Adding code to this part is a tradeoff between overhead and planning performance.
