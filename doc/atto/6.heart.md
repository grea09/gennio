...
In this chapter we showed two planners that are orriented towards real time and flexibility. This makes fast decision making easier and improves the expressive power of domain writing tools such as the one we presented in @ch:color.
