...
::: example
In the classical genealogy example, the TBox can be a statement similar to $\textrm{Woman} = \textrm{Person} \cap \textrm{Female}$. This is a reasoning about the concept hierarchy and is usually modeled at design time.
