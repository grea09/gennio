...
<!--TODO: emphasis on contribution: add dynamic grammar to ontologies ++ -->

To summarize, that framework must maximize the following criteria:

1. **Neutral**: Must be independent from preferences and regional localization.
...
<!--TODO: SELF comparison table with these criterions-->
<!--TODO: Explain and justify the table!!!!!!-->
...
<!--TODO: explain what theorems are-->
...
<!--FIXME: rephrase the 2 language stuff-->
