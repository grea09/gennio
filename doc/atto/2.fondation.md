...
::: example
Reusing the functions of the previous example, we can note that $f_3 \vartriangle f_1 = f_1$ because $1 \to 2$ is the only combination that both functions associates. <!--FIXME: not clear (samir)-->
:::
