...
: Planners participating in the Classic track of the 2018 International Planning Competition (IPC). Most of the planners uses the FastDownward framework. {#tbl:ipc}
