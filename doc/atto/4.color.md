# General Planning Framework {#ch:color}
...
However, in the next section we aim to create such a general planning formalism. The main goal is to design the automated planning community with a general unifying framework it so badly needs.
...
This definition can express any kind of plans, either temporal, fully or partially ordered or even hierarchical plans (using the methods of the actions $\plans$). It can even express diverse planning results.
