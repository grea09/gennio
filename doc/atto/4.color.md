...
::: example
In the domain block world, we can express a couple of states as set of fluents:
...
::: example
Using previously defined example states $\smwhtsquare_{1,2,3}$, and adding the following:
