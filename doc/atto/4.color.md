...
We can express a few example of fluent verification:
...
``` {#lst:ma-pddl .pddl caption="Example of MA-PDDL syntax by Kovacs." escapechar=$}
...
```{#lst:webpddl .pddl caption="Example of WebPDDL syntax by Mc Dermott." escapechar=$}
